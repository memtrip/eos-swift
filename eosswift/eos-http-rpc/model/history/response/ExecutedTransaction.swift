...
public struct ExecutedTransaction : Decodable {
    ...
    public init(expiration: Date, ref_block_num: Int, ref_block_prefix: UInt64, max_net_usage_words: UInt64, max_cpu_usage_ms: UInt64, delay_sec: UInt64, context_free_actions: Array<ExecutedTransactionAction>, transaction_extensions: Array<String>, signatures: Array<String>, context_free_data: Array<String>) {
