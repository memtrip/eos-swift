...
public struct HistoricAccountAction : Decodable {
    public let global_action_seq: Int64
    public let account_action_seq: Int64
    public let block_num: Int
    public let block_time: Date
    public let action_trace: TransactionActionTrace

    public init(global_action_seq: Int64, account_action_seq: Int64, block_num: Int, block_time: Date, action_trace: TransactionActionTrace) {
